...
<html lang="en">
  ...
  <title>spring-5-framework-doc/9-Introduction-to-Spring-Testing.md at master · lfvepclr/spring-5-framework-doc</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTc0NDM0NDc2OjU2MTA2ZDQ4MmZhYjhiZDI0N2ZmMWIxODQ4Mjk0MWFkZDlhZWZhNmIzNTUwODRlM2M2ODBhNmRjZDJkMDg4NmU=--4343b180cff8f418abee4ae5f02d2c8fbee9510c">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="CB2E:2E1C7:1CCE635:2C90789:5963DA65" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="reed7">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta content="4045814" name="octolytics-dimension-user_id" /><meta content="lfvepclr" name="octolytics-dimension-user_login" /><meta content="94390120" name="octolytics-dimension-repository_id" /><meta content="lfvepclr/spring-5-framework-doc" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="94390120" name="octolytics-dimension-repository_network_root_id" /><meta content="lfvepclr/spring-5-framework-doc" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/lfvepclr/spring-5-framework-doc/blob/master/9-Introduction-to-Spring-Testing.md" data-pjax-transient>
...
<div class="header" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/lfvepclr/spring-5-framework-doc/search" class="js-site-search-form" data-scoped-search-url="/lfvepclr/spring-5-framework-doc/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/lfvepclr/spring-5-framework-doc/blob/master/9-Introduction-to-Spring-Testing.md" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="vuZXRuoHj7+fQXZTG/51wF5z6QoLhZb/bbrT3af5md7hBjUv9/2SQ9xudgAoDSOygk8vx1tT29r9GRRehSxniA==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="nH3F28AZfMSEOwR+dhw+1ol5WCB7/8cbOKdNTNVbmrvDnaey3eNhOMcUBC1F72ikVUWe7Sspij6oBIrP945k7Q==" /></div>
      <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
        Sign out
      </button>
</form>  </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="S08ZmG3VmTLNmHO+IF8lyrW8udX+IQAwPRj8/yOztCbT6PGsAXy0JjYkp+JJZGklCbYyWB79hRWNagkmgPiQCg==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="94390120" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/lfvepclr/spring-5-framework-doc/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="zlrblsmiAOLnl5DIph0dZU9GFbWCjnR1Jnz4YdPB0vyToifrn37QVxx2VLaaGujCLX/DQOx4EN+KSQvIqfYshA==" /></div>
      <button
        type="submit"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/lfvepclr/spring-5-framework-doc/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wRdAvO9VxKjv43/7XpTbzHXlqnDLXhWJ+cLmZnSjC9YtXvSUiqkxLCSUgKD1GcKazSzs53VREwBmDzfULWkPRQ==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/lfvepclr/spring-5-framework-doc/blob/06d1d5faf1799e487a58ad97436a6d59bee558e9/9-Introduction-to-Spring-Testing.md" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:f78c4fb65c00603f52aacb4c61db5267 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/lfvepclr/spring-5-framework-doc/blob/master/9-Introduction-to-Spring-Testing.md"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/lfvepclr/spring-5-framework-doc"><span>spring-5-framework-doc</span></a></span></span><span class="separator">/</span><strong class="final-path">9-Introduction-to-Spring-Testing.md</strong>
    </div>
  </div>


  <include-fragment class="commit-tease" src="/lfvepclr/spring-5-framework-doc/contributors/master/9-Introduction-to-Spring-Testing.md">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/lfvepclr/spring-5-framework-doc/raw/master/9-Introduction-to-Spring-Testing.md" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/lfvepclr/spring-5-framework-doc/blame/master/9-Introduction-to-Spring-Testing.md" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/lfvepclr/spring-5-framework-doc/commits/master/9-Introduction-to-Spring-Testing.md" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/lfvepclr/spring-5-framework-doc/edit/master/9-Introduction-to-Spring-Testing.md" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="JOzMFcSlsrNxBez986ZgwT7eGUfUyUAwVISJ2y425xf8+MqT40W4IhBKUyqkLrWPBvFH0xEmJcplMAY1efjkew==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Edit the file in your fork of this project" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/lfvepclr/spring-5-framework-doc/delete/master/9-Introduction-to-Spring-Testing.md" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wVMr+RdHcwJAlnr8fJHh/xVe5vLhm39u1bikK57dq/7mrcyhynpeZcVK/5TyTo3ofjXrnWuE+BEltTv/34Qmbw==" /></div>
  ...
  <div id="readme" class="readme blob instapaper_body">
    <article class="markdown-body entry-content" itemprop="text"><h1><a id="user-content-9-spring框架下的测试" class="anchor" href="#9-spring框架下的测试" aria-hidden="true"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>9. Spring框架下的测试</h1>
<p>测试乃企业级软件开发的重要组成部分之一。本章专注于讲解采用 IoC 原则进行编码而给单元测试带来的好处，以及 Spring 框架对集成测试的支持如何为测试带来帮助。（对企业开发中如何进行代码测试的详尽讨论不在本文档讨论范围之内）</p>
</article>
  </div>
...
<div class="container site-footer-container">
  <div class="site-footer " role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.13363s from github-fe132-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
